...
public class MainActivity extends AppCompatActivity {
    ...
    // keys used to identify data between activities
    ...
    protected void sendEmail(View v) {
        Log.i("MainActivity", "Send email");
        String[] TO = {"Wangcees@gmail.com"};
        String[] CC = {""};
    ...
    private void setupListViewListener() {
        ...
        // setup  item listener for edit click
        lvItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.i("MainActivity", "Item edited from the list" + position);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == EDIT_REQUEST_CODE) {
            ...
            // nodify the adapter that the model changed
            itemsAdapter.notifyDataSetChanged();
            //persistent the change model
            writeItems();
